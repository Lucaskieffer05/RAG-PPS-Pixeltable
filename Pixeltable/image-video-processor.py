...
class ImageProcessor:
    ...
    def __init__(self, directory, model='yolox_s', confidence_threshold=0.5):
        self.model = model
        self.confidence_threshold = confidence_threshold
        self.table = pxt.create_table('{directory}.images', {'image': pxt.ImageType()}, if_exists='ignore')
...
class VideoProcessor:
    ...
    def __init__(self, directory, model='yolox_m', confidence_threshold=0.25, fps=1):
        self.model = model
        self.confidence_threshold = confidence_threshold
        self.fps = fps
        self.table = pxt.create_table('{directory}.videos', {'video': pxt.VideoType()}, if_exists='ignore')
